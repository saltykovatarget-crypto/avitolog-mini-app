...
const MONTHLY_THEMES = [
  {
    ...
    topics: {
      1: ["Клиент потратил 15к на VAS — заявок не было. Разобрались за 10 минут.", "Юридические услуги, Москва: 3 заявки → 18 за 10 дней", "Мебель на заказ: платили за продвижение, CTR 0.8%. Нашли проблему."],
      2: ["Одна ошибка в заголовке которая убивает VAS — и как исправить", "Почему объявление не работает даже с продвижением", "Что такое поведенческие сигналы Авито и почему это важнее денег"],
